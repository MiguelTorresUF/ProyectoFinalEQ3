...
import com.example.demo.repository.hotel.HotelRepositoryImpl;
...
public class HotelServiceMockTest {
    ...
    private Hotel hotel01(){
        return new Hotel("CH-0002",
                "Cataratas Hotel",
                "Buenos Aires",
                "Doble",
                6300,
    ...
    private Hotel hotel02(){
        return new Hotel("CH-0003",
                "Cataratas Hotel 2",
                "Puerto Iguazú",
                "Triple",
                8200,
